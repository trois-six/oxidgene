...
pub enum Connector {
    ...
    #[cfg(feature = "__never_native_tls")]
    ...
    S: Read + Write,
{
    ...
    #[cfg(any(feature = "__never_native_tls", feature = "__rustls-tls"))]
    ...
    let stream = match connector {
        ...
        None => {
            ...
            #[cfg(all(feature = "__rustls-tls", not(feature = "__never_native_tls")))]
            {
                self::encryption::rustls::wrap_stream(stream, &domain, mode, None)
            }
            #[cfg(not(any(feature = "__never_native_tls", feature = "__rustls-tls")))]
            {
