...
The account's data archive (`juesce_media_images_1.zip` 599 files + `_2.zip` 24 files) holds **exactly 623 entries = the 623 media views**, one original per view. The ZIPs carry no deposit id, but they can be re-linked **without any site access**:
