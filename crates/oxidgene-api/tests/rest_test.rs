...
async fn test_update_can_clear_a_nullable_field() {
    // The reported bug: editing "de SAMPLE_SURNAME" down to "SAMPLE_SURNAME" left the person
    // still named "de SAMPLE_SURNAME". The UI correctly sent `"surname_prefix": null`,
    ...
    assert_eq!(body["surname"], "SAMPLE_SURNAME");
}
